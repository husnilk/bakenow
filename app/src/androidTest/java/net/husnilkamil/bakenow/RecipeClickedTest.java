...
public class RecipeClickedTest {
    ...
    @Test
    public void recipeClicked_OpenRecipeActivity(){
        onView(withId(R.id.rv_recipes)).perform(RecyclerViewActions.actionOnItemAtPosition(2, click()));
        onView(withId(R.id.text_recipe_ingredient_title)).check(matches(withText("Ingredient")));
    }
